...
plt.tight_layout()
plt.savefig("posts/amazon-dynamic-pricing/thumbnail.png", dpi=150, bbox_inches="tight")
plt.show()
```
...
for x, y, label, color in signals:
    ax.add_patch(plt.FancyBboxPatch((x-0.8, y-0.35), 1.6, 0.7,
...
# Central box
ax.add_patch(plt.FancyBboxPatch((3.5, 2.5), 3.0, 3.0,
